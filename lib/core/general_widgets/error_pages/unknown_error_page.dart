...
Widget unKnownErrorPage({required BuildContext context,required void Function() onTapped }) {
  ...
  return ListView(
    ...
    children: [
      ...
      Align(
        alignment: Alignment.center,
        child: Text('Oops! an error occurred', style: primaryTextTheme.headline2!.copyWith(color: Theme.of(context).primaryColor),)),
      SizedBox(height: 50,),
      Align(
        alignment: Alignment.center,
