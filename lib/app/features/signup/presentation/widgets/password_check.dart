    ...
    return GetX<SignupController>(builder: (_) {
      return _.startedTypingPw? Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Your password must have the following', style: primaryTextTheme.bodyText1,),
                ...
                text: TextSpan(
                    ...
                    style: TextStyle(
                        color: _.hasUppercase
                            ? Colors.green
                            : primaryTextTheme.subtitle1!.color),
                    children: const [TextSpan(text: ' At least  1 uppercase letter')])),
           const SizedBox(height: 2,),
            RichText(
                text: TextSpan(
                    text: _.hasLowercase?'✅':'•',
                    style: TextStyle(
                        color: _.hasLowercase
                            ? Colors.green
                            : primaryTextTheme.subtitle1!.color),
                    children: const [TextSpan(text: ' At least  1 lowercase letter')])),
            const SizedBox(height: 2,),
            RichText(
                text: TextSpan(
                    text: _.hasNumber? '✅':'•',
